...
export default function Engracado(){
    ...
    useEffect(() => {
      ...
      const insertData = async (e) => {
        ...
        try {
          setLoading(true)
          const res = await axios.post('/api/votar-engracado', { votante_ra, votado_ra }, {
            headers: {
        ...
        <div className="flex flex-col py-4 w-full">
            ...
            {alunos.length>0 ? (
                <form onSubmit={insertData} className="mt-4 flex flex-col mx-auto">
                    ...
                    <Link href='/resultado-votacao-engracado' className='mx-auto mt-8 p-4 text-xl text-blue-800'>Próximo &gt;&gt;</Link>
                </form>
            ) : 
                <LottieAnimation/>
            }
