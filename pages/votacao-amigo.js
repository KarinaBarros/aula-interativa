...
export default function Amigo(){
    ...
    useEffect(() => {
      ...
      const insertData = async (e) => {
        ...
        try {
          setLoading(true)
          const res = await axios.post('/api/votar-amigo', { votante_ra, votado_ra }, {
            headers: {
    ...
    return(
        <div className="flex flex-col py-4 w-full">
            ...
            <h1 className='mx-auto text-3xl font-poppins'>Aluno mais amigo</h1>
            ...
            {alunos.length>0 ? (
                <form onSubmit={insertData} className="mt-4 flex flex-col mx-auto">
                    ...
                    <Link href='/resultado-votacao-amigo' className='mx-auto mt-8 p-4 text-xl text-blue-800'>Próximo &gt;&gt;</Link>
                </form>
            ) : 
            <LottieAnimation/>
            }
