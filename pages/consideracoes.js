...
export default function Intuito() {
    return (
        <div className="flex flex-col px-16 py-4 h-screen w-full">
            ...
            <p className='ml-8 text-lg indent-16'>Tanto a brincadeira do jogo da discórdia quanto a aplicação do teste e exibição do gabarito foram executadas inserindo e lendo dados do nosso banco de dados, utilizando principalmente a tabela &quota;lunos&quot;.</p>
